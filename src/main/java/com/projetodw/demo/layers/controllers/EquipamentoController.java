...
public class EquipamentoController {
    ...
    public ResponseEntity<?> getRequisicao(@PathVariable Long idEquipamento){
        try{
            equipamentoService.GetEquipamento(idEquipamento);
            return ResponseEntity.status(HttpStatus.OK).body(equipamentoService.GetEquipamento(idEquipamento));
