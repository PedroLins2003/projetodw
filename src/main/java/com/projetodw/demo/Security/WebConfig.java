    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
            ...
            .authorizeHttpRequests(authorizeConfig ->
                ...
                .requestMatchers(HttpMethod.POST,"/situacao").permitAll()
                ...
                .requestMatchers(HttpMethod.PUT,"/situacao").permitAll()
                ...
                .requestMatchers(HttpMethod.DELETE,"/situacao").permitAll()
                .requestMatchers(HttpMethod.GET, "/clientes/{id:[0-9]+}").permitAll()
                .requestMatchers(HttpMethod.GET, "/equipamento/{id:[0-9]+}").permitAll()
                .requestMatchers(HttpMethod.GET, "/requisicao/{id:[0-9]+}").permitAll()
                .requestMatchers(HttpMethod.GET, "/requisicaoequipamento/{id:[0-9]+}").permitAll()
                .requestMatchers(HttpMethod.GET, "/requisicaoservico/{id:[0-9]+}").permitAll()
                .requestMatchers(HttpMethod.GET, "/situacao/{id:[0-9]+}").permitAll()
